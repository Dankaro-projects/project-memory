...
```sh
uvx project-memory-mcp@0.6.0b14 setup --client codex --trust
```
...
```sh
uv tool install project-memory-mcp==0.6.0b14
...
```sh
uvx --from https://github.com/Dankaro-projects/project-memory/releases/download/v0.6.0b14/project_memory_mcp-0.6.0b14-py3-none-any.whl project-memory setup --client claude --trust
```
