...
```sh
uv tool install project-memory-mcp==0.6.0b10
...
```sh
uvx --from https://github.com/Dankaro-projects/project-memory/releases/download/v0.6.0b10/project_memory_mcp-0.6.0b10-py3-none-any.whl project-memory setup --client claude --trust
```
