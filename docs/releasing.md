...
Python uses `0.6.0b16` and plugin metadata uses the equivalent `0.6.0-beta.16`. Update these together:

| File | Form |
| --- | --- |
| `pyproject.toml` | `0.6.0b16` |
| `memory_module/__init__.py` | `0.6.0b16` |
| `plugins/project-memory/.claude-plugin/plugin.json` | `0.6.0-beta.16` |
| `plugins/project-memory/.codex-plugin/plugin.json` | `0.6.0-beta.16` |
| `.claude-plugin/marketplace.json` | `0.6.0-beta.16` |
